...
<head>
  ...
  <title>@yield('title') | POS Vitara Audio
  ...
  <!-- Canonical SEO -->
  <link href="{{ config('variables.productPage') ? config('variables.productPage') : '' }}" rel="canonical">
  <!-- Favicon -->
  <link type="image/x-icon" href="{{ asset('assets/img/favicon/favicon.ico') }}" rel="icon" />
